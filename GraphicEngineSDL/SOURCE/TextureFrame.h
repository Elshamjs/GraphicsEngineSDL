...
class TextureFrame : public VObject
{
public:
	TextureFrame(float xpos, float ypos, float width, float height, Assets::TEXTURE tex, LAYER object_layer);
	TextureFrame(float xpos, float ypos, float width, float height, SDL_Texture* tex, LAYER object_layer);
	void changeTexture(SDL_Texture* tex);
	void changeTexture(Assets::TEXTURE new_texture);
	void setHoverTexture(Assets::TEXTURE tex);
	void setHoverTexture(SDL_Texture* tex);
